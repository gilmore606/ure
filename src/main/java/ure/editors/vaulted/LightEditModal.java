...
public class LightEditModal extends UModal {
    ...
    public LightEditModal(VaultedModal vaulted, ULight light) {
        ...
        rSlider = new WidgetHSlider(this,0,0,8,light.getColor().iR(),0,255,true);
        gSlider = new WidgetHSlider(this,0,1,8,light.getColor().iG(),0,255,true);
        bSlider = new WidgetHSlider(this,0,2,8,light.getColor().iB(),0,255,true);
        ...
        flickerSpeedSlider = new WidgetHSlider(this, 5, 5, 8, (int)(light.getFlickerSpeed()*100f), 0, 800, false);
        addWidget(new WidgetText(this, 0, 5, "speed:"));
        addWidget(flickerSpeedSlider);
        flickerIntensitySlider = new WidgetHSlider(this, 5, 6, 8, (int)(light.getFlickerIntensity()*100f), 0, 100, false);
